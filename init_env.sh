...
echo "即将更新软件源信息"
apt update      # 更新软件包索引信息，确保你获得的是最新的可用包列表。
echo "即将安装 C/C++、Java环境，Python3.10默认已经安装（Ubuntu22）"
apt install -y git zsh gcc g++ openjdk-8-jdk glibc-doc autojump universal-ctags
